...
//Por ejemplo, el número 2 debería convertirse en 4, el número 4 en 16, y así sucesivamente.
// Al final, imprime la nueva lista.

let numeros = [2, 4, 6, 8];

let AlCuadrado = numeros.map(function(numeros){
    return numeros*numeros
});
console.log("El cuadrado de los números es: " + AlCuadrado);
